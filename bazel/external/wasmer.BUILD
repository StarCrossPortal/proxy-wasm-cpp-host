...
rust_library(
    ...
    deps = [
        ":helpers_lib",
        "@proxy_wasm_cpp_host//bazel/cargo:wasmer_api",
        "@proxy_wasm_cpp_host//bazel/cargo:wasmer_compiler_llvm",
        "@proxy_wasm_cpp_host//bazel/cargo:wasmer_emscripten",
        "@proxy_wasm_cpp_host//bazel/cargo:wasmer_engine",
        "@proxy_wasm_cpp_host//bazel/cargo:wasmer_engine_universal",
        "@proxy_wasm_cpp_host//bazel/cargo:wasmer_engine_dylib",
        "@proxy_wasm_cpp_host//bazel/cargo:wasmer_engine_staticlib",
        "@proxy_wasm_cpp_host//bazel/cargo:wasmer_middlewares",
        "@proxy_wasm_cpp_host//bazel/cargo:wasmer_wasi",
